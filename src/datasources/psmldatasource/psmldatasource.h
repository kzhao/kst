...
class PSMLDatasourceSource : public Kst::DataSource {
  Q_OBJECT

  public:
    PSMLDatasourceSource(Kst::ObjectStore *store, QSettings *cfg, const QString& filename, const QString& type, const QDomElement& e);

    ~PSMLDatasourceSource();
...
class PSMLDatasourcePlugin : public QObject, public Kst::DataSourcePluginInterface {
    Q_OBJECT
    Q_INTERFACES(Kst::DataSourcePluginInterface)
    Q_PLUGIN_METADATA(IID "com.kst.DataSourcePluginInterface/2.0")
  public:
    virtual ~PSMLDatasourcePlugin() {}
